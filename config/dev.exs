...
config :http_client_phx, HttpClientPhx.Repo,
  ...
  port: System.get_env("PSQL_PORT") || 5432,
  timeout: 240_000,
...
config :http_client_phx, HttpClientPhxWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "i8vN09+/yWp9TpmxqW166CZLh2d+TQYeCZyiUzv+iCZURASk/Ko7gqohop+QF8TA",
  watchers: [
...
config :http_client_phx, HttpClientPhxWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/http_client_phx_web/(live|views)/.*(ex)$",
      ~r"lib/http_client_phx_web/templates/.*(eex)$"
    ]
  ]
